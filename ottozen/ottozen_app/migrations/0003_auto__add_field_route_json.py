...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Route.json'
        db.add_column('ottozen_app_route', 'json', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Route.json'
        db.delete_column('ottozen_app_route', 'json')
