...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.mobile_num'
        db.alter_column('ottozen_app_userprofile', 'mobile_num', self.gf('django.db.models.fields.CharField')(max_length=11))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.mobile_num'
        db.alter_column('ottozen_app_userprofile', 'mobile_num', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'ottozen_app.point': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'point'", 'to': "orm['auth.User']"})
        },
        'ottozen_app.route': {
            'Meta': {'object_name': 'Route'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_time': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'routes'", 'to': "orm['auth.User']"}),
        ...
        'ottozen_app.userprofile': {
            ...
            'mobile_num': ('django.db.models.fields.CharField', [], {'default': "'1918.......'", 'max_length': '11'}),
